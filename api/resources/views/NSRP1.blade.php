...
<head>
    ...
    <title>NSRP-Employers Form</title>
...
<body>
    ...
    <div class="container my-5">
        <h2>National Skills Registration Program Employeers Form</h2>
        <form id="nsrpForm">
            @csrf
        ...
        function handleSubmit(event) {
            ...
            for (let i = 0; i < cardCount; i++) {
                const job = {
                    ...
                    work_experience_duration:formData.getAll('work_experience_duration[]')[i],
                    work_experience:formData.getAll(`work_experience[${i}][]`),
...
<body>
    ...
    <div class="container my-5">
        <h2>National Skills Registration Program Employers Form</h2>
        <form id="nsrpForm" novalidate>
            @csrf

            <!-- I. Establishment Information collè-->
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-9">
                    <input type="text" id="establishment" class="form-control" name="establishment" required>
                    <div class="invalid-feedback">Please enter the establishment name.</div>
                </div>
            </div>
            <div class="row mb-3">
                <label for="business_address" class="col-sm-3 col-form-label">Business Address:</label>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-9">
                    <input type="text" id="industry_classification" class="form-control" name="industry_classification" required>
                    <div class="invalid-feedback">Please enter the industry classification.</div>
                </div>
            </div>
            <div class="row mb-3">
                <label for="business_type" class="col-sm-3 col-form-label">Business Type:</label>
            ...
            <div class="row mb-3">
                <label for="contact_number" class="col-sm-3 col-form-label">Contact Number:</label>
                <div class="col-sm-9">
                    <input type="tel" id="contact_number" class="form-control" name="contact_number" pattern="\+?[0-9\s\-()]{7,15}" required>
            ...
            <!-- II. Vacancy Information & III. Qualification Requirements -->
            <div class="section-title">II. Vacancy Information & III. Qualification Requirements</div>
            <div id="cardContainer"></div>

            <template id="templateCard">
                <div class="card job-card" role="region" aria-label="Vacancy Card">
                    <div class="row mb-3">
                        <label for="position_title_${cardIndex}" class="col-sm-3 col-form-label">Position Title:</label>
                        <div class="col-sm-9">
                            <input type="text" id="position_title_${cardIndex}" class="form-control" name="position_title[]" required>
                    ...
                    <div class="row mb-3">
                        <label for="number_of_vacancies_${cardIndex}" class="col-sm-3 col-form-label">Number of Vacancies:</label>
                        <div class="col-sm-9">
                            <input type="number" id="number_of_vacancies_${cardIndex}" class="form-control" name="number_of_vacancies[]" min="1" required>
                            <div class="invalid-feedback">Please enter a valid number of vacancies.</div>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label for="job_description_${cardIndex}" class="col-sm-3 col-form-label">Job Description:</label>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="text" id="place_of_assignment_${cardIndex}" class="form-control" name="place_of_assignment[]" required>
                            <div class="invalid-feedback">Please enter the place of assignment.</div>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label for="employment_status_${cardIndex}" class="col-sm-3 col-form-label">Employment Status:</label>
                    ...
                    <div class="row mb-3">
                        <label for="salary_range_${cardIndex}" class="col-sm-3 col-form-label">Salary:</label>
                        <div class="col-sm-9">
                            <input type="number" id="salary_range_${cardIndex}" class="form-control" name="salary_range[]" min="0" required>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="text" id="duration_of_employment_${cardIndex}" class="form-control" name="duration_of_employment[]" required>
                            <div class="invalid-feedback">Please enter the duration of employment.</div>
                        </div>
                    </div>
                    <div style="font-weight: 700; margin-top:20px">Qualification Requirements</div>
                    <hr class="hr"/>
                    <div class="row mb-3">
                        <label for="education_${cardIndex}" class="col-sm-3 col-form-label">Education:</label>
                        <div class="col-sm-9">
                            <select id="education_${cardIndex}" class="form-select education" name="education[${cardIndex}][]" multiple required aria-multiselectable="true">
                            ...
                            <div class="invalid-feedback">Please select at least one education level.</div>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label for="work_experience_${cardIndex}" class="col-sm-3 col-form-label">Work Experience:</label>
                        <div class="col-sm-9">
                            <select id="work_experience_${cardIndex}" class="form-select workExperience" name="work_experience[${cardIndex}][]" multiple required aria-multiselectable="true">
                            ...
                            <div class="invalid-feedback">Please select at least one work experience.</div>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label for="work_experience_duration_${cardIndex}" class="col-sm-3 col-form-label">Work Experience (month/s):</label>
                        <div class="col-sm-9">
                            <input type="number" id="work_experience_duration_${cardIndex}" class="form-control" name="work_experience_duration[${cardIndex}]" min="0" required>
                            <div class="invalid-feedback">Please enter a valid work experience duration.</div>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label for="skills_required_${cardIndex}" class="col-sm-3 col-form-label">Skills Required:</label>
                        <div class="col-sm-9">
                            <select id="skills_required_${cardIndex}" class="form-select skillsRequired" name="skills_required[${cardIndex}][]" multiple required aria-multiselectable="true">
                    ...
                    <div class="row mb-3">
                        <label for="language_dialect_${cardIndex}" class="col-sm-3 col-form-label">Language/Dialect:</label>
                        <div class="col-sm-9">
                            <select id="language_dialect_${cardIndex}" class="form-select languageDialect" name="language_dialect[${cardIndex}][]" multiple aria-multiselectable="true">
    ...
    <script>
        ...
        function addCard() {
            ...
            clone.querySelectorAll('[name], [id], [for]').forEach(el => {
                if (el.name) {
                    if (el.name.includes('education')) {
                        ...
                        el.name = `language_dialect[${cardIndex}][]`;
                    } else if (el.name.includes('work_experience_duration')) {
                        el.name = `work_experience_duration[${cardIndex}]`;
                    } else if (el.name.includes('work_experience')) {
                        el.name = `work_experience[${cardIndex}][]`;
                    } else {
                        el.name = el.name.replace('${cardIndex}', cardIndex);
                    }
                }
                if (el.id) {
                    el.id = el.id.replace('${cardIndex}', cardIndex);
            ...
            wrapper.querySelectorAll('select[multiple]').forEach(select => {
                if (!select.classList.contains('choices-initialized')) {
        ...
        function handleSubmit(event) {
            ...
            const formData = new FormData(form);
            const json = {
                access_code: new URLSearchParams(window.location.search).get('id'),
                establishment: formData.get('establishment'),
                business_address: formData.get('business_address'),
                industry_classification: formData.get('industry_classification'),
                business_type: formData.get('business_type'),
            ...
            for (let i = 0; i < cardCount; i++) {
                const job = {
                    ...
                    number_of_Vacancies: formData.getAll('number_of_vacancies[]')[i],
                    job_description: formData.getAll('job_description[]')[i],
                    place_of_assignment: formData.getAll('place_of_assignment[]')[i],
                    employment_status: formData.getAll('employment_status[]')[i],
                    salary: formData.getAll('salary_range[]')[i],
                    duration_of_employment: formData.getAll('duration_of_employment[]')[i],
                    education: formData.getAll(`education[${i}][]`),
                    work_experience: formData.getAll(`work_experience[${i}][]`),
                    work_experience_duration: formData.get(`work_experience_duration[${i}]`),
                    skills_required: formData.getAll(`skills_required[${i}][]`),
                    preferred_sex: formData.getAll('preferred_sex[]')[i],
                    age_requirement: formData.getAll('age_requirement[]')[i],
                    language_dialect: formData.getAll(`language_dialect[${i}][]`),

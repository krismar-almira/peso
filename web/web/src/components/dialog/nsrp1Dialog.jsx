                    ...
                    <Box key={index} mb={3}>
                        ...
                        <Grid container spacing={2}>
                            ...
                            <Grid item xs={6}>
                                ...
                                <Typography><strong>Work Experience Duration:</strong> {position.work_experience_duration} month(s)</Typography>
                                <Typography sx={{ mt: 1 }}><strong>Education:</strong></Typography>
                                {position.education.map((edu, i) => <Chip key={i} label={edu} size="small" sx={{ mr: 1, mt: 0.5 }} />)}
                                <Typography sx={{ mt: 1 }}><strong>Work Experience:</strong></Typography>
                                {position.work_experience.map((exp, i) => <Chip key={i} label={exp} size="small" sx={{ mr: 1, mt: 0.5 }} />)}
